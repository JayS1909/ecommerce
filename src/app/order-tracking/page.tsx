  ...
  return (
    <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
      <div className="bg-white rounded-lg shadow-md p-8">
        <h1 className="text-3xl font-extrabold text-gray-900 mb-6 text-center">Track Your Order</h1>
        <p className="text-gray-600 mb-8 text-center">Enter your order details below to track your shipment's current status.</p>
        ...
        <form onSubmit={handleTrack} className="space-y-6">
          ...
          <button type="submit" className="w-full bg-black text-white px-4 py-3 rounded-md font-bold hover:bg-gray-800 transition">
            Track Order
          </button>
        </form>
          ...
          <div className="mt-10 p-6 border border-gray-200 rounded-lg bg-gray-50">
            ...
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center border-b pb-4 mb-4">
              ...
              <div className="mt-4 sm:mt-0">
                <p className="text-sm text-gray-500 uppercase tracking-wider font-semibold">Expected Delivery</p>
                <p className="text-lg font-bold text-gray-900">{trackingResult.expected}</p>
              </div>
            </div>
              ...
              <div className="space-y-6">
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-500">Oct 16, 2023 - 8:45 AM</p>
                  </div>
                </div>
                <div className="flex items-start">
                  <div className="w-8 h-8 rounded-full bg-blue-500 text-white flex items-center justify-center font-bold mr-4 z-10 shrink-0">✓</div>
                  <div>
                    ...
                    <p className="text-sm text-gray-500">Oct 14, 2023 - 2:30 PM</p>
                  </div>
                </div>
                <div className="flex items-start">
                  <div className="w-8 h-8 rounded-full bg-blue-500 text-white flex items-center justify-center font-bold mr-4 z-10 shrink-0">✓</div>
                  <div>
                    ...
                    <p className="text-sm text-gray-500">Oct 13, 2023 - 10:15 AM</p>
                  </div>
                </div>
              </div>
            </div>
