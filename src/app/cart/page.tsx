      ...
      <div className="flex flex-col lg:flex-row gap-12">
              ...
              <li key={item.id} className="flex py-6">
                ...
                <div className="ml-4 flex flex-1 flex-col">
                  <div>
                    ...
                    <p className="mt-1 text-sm text-gray-500">{item.category} • Size: M</p>
                  </div>
        ...
        <div className="lg:w-1/3">
          <div className="bg-gray-50 rounded-lg p-6 shadow-sm">
            ...
            <div className="mt-6">
              <Link href="/checkout" className="w-full flex items-center justify-center rounded-md border border-transparent bg-black px-6 py-3 text-base font-medium text-white shadow-sm hover:bg-gray-800">
                Checkout
              </Link>
            </div>
