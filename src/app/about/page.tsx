export default function AboutPage() {
  return (
    <div className="max-w-4xl mx-auto px-4 py-20">
      <h1 className="text-4xl font-black uppercase tracking-tight mb-8 text-center">About Us</h1>
      <div className="prose dark:prose-invert mx-auto space-y-6">
        ...
        <p>At EXTRAALAYER, we create premium streetwear that sits at the intersection of comfort, culture, and design. From minimal aesthetics and statement graphics to acid-washed textures and oversized silhouettes — every piece is built to feel personal.</p>

        <h2 className="text-2xl font-bold mt-8 mb-4">Brand Statement</h2>
        <p>EXTRAALAYER is more than clothing. It&apos;s the extra layer of confidence you put on before you face the world.</p>
      </div>
    </div>
  );
}
